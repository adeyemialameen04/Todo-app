  ...
  const stepsHtml = steps
	.map(
	  ...
	  <li class="step-card" data-index="${index}">
		<div>
		<span aria-live="polite" id="shopping-item-checkbox-status-${index}"></span>
		  <button  role="menuitem"  aria-label="Mark ${step.title} as done" id="shopping-item-checkbox-${index}" class="shopping-item-checkbox">
		  <svg
			width="30"
			height="30"
			viewBox="0 0 32 32"
		  ...
		  <button aria-label=${step.ariaLabel} class="step-title">
			${step.title}
		  </button>
		</div>
